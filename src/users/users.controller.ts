...
export class UsersController {
  ...
  updateCart(@Param('id') id: string, @Body() body: UpdateUserDto, @User() user : IUser) {
    return this.usersService.updateCart(id, body,user);
  }

  @Delete('/cart/:id')
  @ResponseMessage('Update cart for user')
  deleteCart(@Param('id') id: string, @Body() body: UpdateUserDto, @User() user : IUser) {
    return this.usersService.deleteCart(id, body,user);
  }
